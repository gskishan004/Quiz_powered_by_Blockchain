...
var events = contractInstance.find_winners({from: account, gas:6721975});

console.log("response -> ", events);

var events = contractInstance.get_winners({from: account, gas:6721975});

console.log("winners  -> ", events);